...
class BaseAlgorithmV2(ABC):
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        BaseAlgorithmV2._registry[cls.__name__] = cls
    ...
    def get_algorithm(name: str, config: dict):
        ...
        """
        if name not in BaseAlgorithmV2._registry:
            raise ValueError(
