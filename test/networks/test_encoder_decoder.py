...
class EncoderDecoderTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.decoder = Decoder(cls.z_t_size, cls.tensor.shape)
    ...
    def test_encoder_creation(self):
        ...
        self.assertEqual(self.encoder.fc2.out_features, self.z_t_size)
    ...
    def test_latent_state_size(self):
        ...
        """
        self.assertEqual(self.encoder.fc2.out_features, self.decoder.fc1.in_features)
